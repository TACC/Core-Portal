...
class Permissions:
    ...
    def for_user(self, username):
        ...
        return Permission(
            {"username": username, "recursive": False, "permission": {"read": False, "write": False, "execute": False}}
        )
    ...
    def save(self):
        ...
        for pem in self.to_update:
            res = self._ac.files.updatePermissions(
                filePath=self.parent.path, systemId=self.parent.system, body=pem.to_dict()
            )
