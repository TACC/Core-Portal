...
LOGGING = {
    ...
    "formatters": {
        "default": {
            "format": "[DJANGO] %(levelname)s %(asctime)s UTC %(module)s %(name)s.%(funcName)s:%(lineno)s: %(message)s"
        },
        "tapis": {
            "format": "[TAPIS] %(levelname)s %(asctime)s UTC %(module)s %(name)s.%(funcName)s:%(lineno)s: %(message)s"
        },
        "metrics": {
...
CELERY_RESULT_BACKEND = "".join(
    [_RESULT_BACKEND_PROTOCOL, _RESULT_BACKEND_HOST, ":", _RESULT_BACKEND_PORT, "/", _RESULT_BACKEND_DB]
)
...
CELERYD_LOG_FORMAT = (
    "[DJANGO] $(processName)s %(levelname)s %(asctime)s %(module)s %(name)s.%(funcName)s:%(lineno)s: %(message)s"
)
