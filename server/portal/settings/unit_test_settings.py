...
PORTAL_USER_ACCOUNT_SETUP_STEPS = [{"step": "portal.apps.onboarding.steps.test_steps.MockStep", "settings": {"key": "value"}}]
...
EXTERNAL_RESOURCE_SECRETS = {"google-drive": {"client_secret": "test", "client_id": "test", "name": "Google Drive", "directory": "external-resources"}}
...
LOGGING = {
    ...
    "formatters": {
        "default": {"format": "[DJANGO-TEST] %(levelname)s %(asctime)s %(module)s %(name)s.%(funcName)s:%(lineno)s: %(message)s"},
        "metrics": {
...
PORTAL_DATAFILES_STORAGE_SYSTEMS = [
    {"name": "My Data (Work)", "system": "cloud.data", "scheme": "private", "api": "tapis", "homeDir": "/home/{username}", "icon": None, "default": True},
    {
