...
urlpatterns = [
    ...
    # accounts.
    path(
        "accounts/", include("portal.apps.accounts.urls", namespace="portal_accounts")
    ),
    path(
        "api/accounts/",
        include("portal.apps.accounts.api.urls", namespace="portal_accounts_api"),
    ),
    path(
        "api/onboarding/",
        include("portal.apps.onboarding.api.urls", namespace="portal_onboarding_api"),
    ),
    path(
        "register/",
        RedirectView.as_view(pattern_name="portal_accounts:register", permanent=True),
        name="register",
    ),
    # auth.
    ...
    re_path(
        "core/markup/nav",
        TemplateView.as_view(template_name="includes/nav_portal.raw.html"),
        name="portal_nav_markup",
    ),
    # api
    ...
    path(
        "api/workbench/",
        include("portal.apps.workbench.api.urls", namespace="workbench_api"),
    ),
    path(
        "api/workspace/",
        include("portal.apps.workspace.api.urls", namespace="workspace_api"),
    ),
    path(
        "api/tickets/",
        include("portal.apps.tickets.api.urls", namespace="portal_tickets_api"),
    ),
    path(
        "api/request-access/",
        include("portal.apps.request_access.api.urls", namespace="request_access_api"),
    ),
    path(
        "api/datafiles/", include("portal.apps.datafiles.urls", namespace="datafiles")
    ),
    path(
        "api/system-monitor/",
        include("portal.apps.system_monitor.urls", namespace="system_monitor"),
    ),
    path(
        "api/notifications/",
        include("portal.apps.notifications.urls", namespace="notifications"),
    ),
    path("api/news/", include("portal.apps.news.api.urls", namespace="news_api")),
    path(
        "api/jupyter_mounts/",
        include("portal.apps.jupyter_mounts.api.urls", namespace="jupyter_mounts_api"),
    ),
    path("api/projects/", include("portal.apps.projects.urls", namespace="projects")),
    path(
        "api/site-search/",
        include("portal.apps.site_search.api.urls", namespace="site_search_api"),
    ),
    path("api/forms/", include("portal.apps.forms.urls", namespace="forms")),
    path(
        "api/publications/",
        include("portal.apps.publications.urls", namespace="publications_api"),
    ),
    # webhooks
    ...
    path(
        "googledrive-privacy-policy/",
        include(
            "portal.apps.googledrive_integration.urls",
    ...
    path(
        "published-datasets/",
        include("portal.apps.public_data.urls", namespace="publications"),
    ),
    path(
        "request-access/",
        include("portal.apps.request_access.urls", namespace="request_access"),
    ),
    ...
    path(
        "api/portal_messages/",
        include("portal.apps.portal_messages.urls", namespace="portal_messages"),
    ),
    # integrations
    path(
...
if settings.WORKBENCH_SETTINGS.get("hasCustomEndpoints"):
    urlpatterns.append(
        path(
            ...
            include(
                f"portal.apps._custom.{settings.PORTAL_NAMESPACE.lower()}.urls",
                namespace="custom",
            ),
        )
    )
