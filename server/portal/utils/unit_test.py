    ...
    def setUp(self):
        ...
        self.job = {
            "inputs": {
                ...
                "inputFiles": ["agave://test.system/test file 1.txt", "agave://test.system/test file 2.txt"],
            }
        }
...
class TestAgaveJWTAuth(TestCase):
    ...
    @patch(
        ...
        return_value={
            ...
            "http://wso2.org/claims/role": ("Internal/PORTALS_wma_prtl_cep.dev_PRODUCTION,"),
    ...
    def test_login_user_agave_jwt(self, mock_decode_jwt, mock_get_jwt_payload, mock_login):
    ...
    def test_agave_jwt_expired_token(self, mock_client, mock_decode_jwt, mock_get_jwt_payload, mock_login):
