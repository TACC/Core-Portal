...
def initialize_token(request):
    redirect_uri = "https://{}{}".format(request.get_host(), reverse("googledrive_integration:oauth2_callback"))
...
def disconnect(request):
    ...
    try:
        ...
        logger.warn("Disconnect Google Drive; GoogleDriveUserToken does not exist.", extra={"user": request.user})
