...
class TestSwapReindex(TestCase):
    ...
    def setUp(self):
        self.patch_setup = patch(
            "portal.apps.search.management.commands.reindex-files.setup_files_index"
        )
        self.patch_connections = patch(
            "portal.apps.search.management.commands.reindex-files.connections"
        )
        self.patch_elasticsearch = patch(
            "portal.apps.search.management.commands.reindex-files.elasticsearch"
        )
        ...
        mock_alias = {
            "actions": [
                {"remove": {"index": "DEFAULT_NAME", "alias": "test-staging-files"}},
                {
                    "remove": {
                        "index": "REINDEX_NAME",
                        "alias": "test-staging-files-reindex",
                    }
                },
                {
                    "add": {
