            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="rel_owner_abstractprojectmetadata",
                        related_query_name="owner_abstractprojectmetadata",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="rel_pi_abstractprojectmetadata",
                        related_query_name="pi_abstractprojectmetadata",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="projects.AbstractProjectMetadata",
                    ),
                ),
            ],
