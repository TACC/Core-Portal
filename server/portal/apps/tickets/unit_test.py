...
def mock_render(mocker):
    yield mocker.patch(
        "portal.apps.tickets.views.render", return_value=HttpResponse("OK")
    )
...
@pytest.mark.parametrize(
    ...
    [
        {
            "id": 1,
            "Requestors": ["UserName1@Example.COM", "Username2@Example.com"],
            "Cc": [],
        },
        {
            "id": 1,
...
@pytest.mark.parametrize(
    ...
    [
        {
            "id": 1,
            "Requestors": ["Foo@example.com"],
            "Cc": ["UserName1@Example.COM", "username2@example.com"],
        },
        {
            "id": 1,
            "Requestors": ["Foo@example.com"],
