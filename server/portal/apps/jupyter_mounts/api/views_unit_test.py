    ...
    mock.return_value = [
        {
            ...
            "owner": {"username": "jarosenb", "first_name": "Jake", "last_name": "Rosenberg", "email": "jrosenberg@tacc.utexas.edu"},
            "title": "test",
            "description": None,
        },
        {
...
def test_get(authenticated_user, client, mock_projects, mock_project_pems, get_user_data):
    ...
    expected = [
        {"path": "/path/to/community", "mountPath": "/test/Community Data", "pems": "ro"},
        {"path": "/path/to/public", "mountPath": "/test/Public Data", "pems": "ro"},
        {"path": "/home/username", "mountPath": "/test/My Data (Work)", "pems": "rw"},
        {"path": "/home1/01234/username", "mountPath": "/test/My Data (Frontera)", "pems": "rw"},
        {"path": "/projects/cep.project-1", "mountPath": "/test/My Projects/test", "pems": "rw"},
        {"path": "/projects/cep.project-2", "mountPath": "/test/My Projects/test (cep.project-2)", "pems": "ro"},
    ]
