        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="The short name of the Agave app",
                        max_length=64,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="The version number of the app",
                        max_length=64,
                    ),
                ),
                (
                    "revision",
                    models.CharField(
                        blank=True, help_text="The revision of the app", max_length=3
                    ),
                ),
                (
                    "appId",
                ...
                (
                    "lastRetrieved",
                    models.CharField(
                        help_text="The latest retrieved version of this app",
                        max_length=64,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="A non-agave portal specific ID for an HTML app",
                        max_length=64,
                    ),
                ),
                (
                ...
                (
                    "shortDescription",
                    models.TextField(
                        blank=True, default="", help_text="App short description"
                    ),
                ),
                (
                    "category",
