...
urlpatterns = [
    ...
    path(
        "tapis/<str:operation>/<str:scheme>/<str:system>/<path:path>/",
        TapisFilesView.as_view(),
    ),
    path(
        "googledrive/<str:operation>/<str:scheme>/<str:system>/",
        GoogleDriveFilesView.as_view(),
    ),
    path(
        "googledrive/<str:operation>/<str:scheme>/<str:system>/<path:path>/",
        GoogleDriveFilesView.as_view(),
    ),
