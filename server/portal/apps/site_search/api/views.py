...
def cms_search(query_string, offset=0, limit=10):
    ...
    cms_search = (
        ...
        .highlight("title")
        .highlight_options(
            pre_tags=["<b>"], post_tags=["</b>"], require_field_match=False
        )
    ...
    results = list(
        map(lambda x: {**x.to_dict(), "highlight": x.meta.highlight.to_dict()}, res)
    )
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            public_conf = next(
                ...
                and (
                    "siteSearchPriority" in conf
                    and conf["siteSearchPriority"] is not None
                )
            )
            client = (
                ...
                if (
                    ...
                    and request.user.profile.setup_complete
                )
