...
class TasUsersView(BaseApiView):
    ...
    def _getSOAPTASClient(self):
        ...
        try:
            client = Client("https://tas.tacc.utexas.edu/TASWebService/PortalService.asmx?WSDL", transport=Transport(session=session, cache=InMemoryCache()))
        except Exception:
    ...
    def get(self, request):
        ...
        for r in combined_results:
            entry = {"username": r.Login, "email": r.Person.Email, "firstName": r.Person.FirstName, "lastName": r.Person.LastName}
