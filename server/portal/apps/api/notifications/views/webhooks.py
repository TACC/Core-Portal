...
from portal.apps.api.views import BaseApiView
from portal.apps.api.mixins import JSONResponseMixin, SecureMixin
from portal.apps.api.exceptions import ApiException

from portal.apps.workspace.tasks import handle_webhook_request
...
def index_job_outputs(user, job):
    ...
    from portal.apps.api.data.agave.filemanager import FileManager as AgaveFileManager
