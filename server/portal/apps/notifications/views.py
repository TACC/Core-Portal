...
from portal.apps.notifications.models import Notification as LegacyNotification
...
def index(request):
    return render(request, 'portal/apps/notifications/index.html')
...
def generic_webhook_handler(request):
    ...
    if event_type == 'WEB':
        ...
        # TODO: Find correct portal host settings
