    ...
    scholar_meta["entities"] = [
        {
            ...
            "publication_date": pub.value.get("publicationDate")
    ...
    def get_context_data(self, **kwargs):
        ...
        if project_id:
            try:
                ...
                scholar_context, datacite_context, title = get_google_scholar_context(
                    pub
                )
                ...
                logger.exception(
                    f"Failed to build meta tags for project {project_id}: {e}"
                )
