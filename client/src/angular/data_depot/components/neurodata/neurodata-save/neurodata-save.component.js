...
class NeurodataSaveCtrl {
    ...
    chooseDestination(fileListing) {
        this.params.targetSystem = fileListing.system;
        this.params.targetPath = fileListing.path;
        this.file.neurodataSave(this.params);
        this.dismiss();
    }
...
const neurodataSaveComponent = {
    template: require('./neurodata-save.template.html'),
    bindings: {
        resolve: '<',
        close: '&',
        dismiss: '&',
    },
    controller: NeurodataSaveCtrl,
};

export default neurodataSaveComponent;
