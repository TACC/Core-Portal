...
import {
  MLACitation,
  APACitation,
} from '../DataFilesProjectPublish/DataFilesProjectPublishWizardSteps/ReviewAuthors';
      ...
      {node.metadata && node.metadata.data_type === 'sample' ? (
        ...
        <li>
          <Link
            ...
            to={`${ROUTES.PUBLICATIONS}/${system}/${node.name.split('.').pop()}/${node.id.split('_').pop()}`}
          >
      ...
      {metadata.loading || loading ? (
        ...
        metadata?.title && (
          <>
              ...
              <h1>
                ...
                <div className="dropdown project-download-button header__action">
                  <button
                    ...
                    type="button"
                  >
                    <i className="icon icon-download c-button__icon--before">
                      ↓
                    </i>{' '}
                    Download
                  </button>
                  ...
                  >
                    ...
                    <li>
                      <a
                        className="dropdown-item"
                        target="_blank"
                        href={`${BASE_ASSET_URL}/archive/${projectId}/${projectId}_metadata.json`}
                        rel="noreferrer"
                      >
                        Download Metadata{' '}
                      </a>
            ...
            <div
              className={'o-section o-section--style-muted proj dect-citation'}
            >
            ...
            <div className={'o-section o-section--style-light'}>
              <div className={'row project-overview'}>
                <div
                  className={'col col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3'}
                >
                  {metadata.cover_image && (
                    <a href={imageUrl} target="_blank" rel="noreferrer">
                      <img
                        src={imageUrl}
                        alt={metadata.title}
                        className={`align-left img-fluid ${styles.image}`}
                      />
                    </a>
                  )}
                </div>
                <div className={'col project-desc'}>
                  ...
                  <table
                    className={
                      'c-data-list c-data-list--is-vert c-data-list--is-narrow'
                    }
                  >
                    <tbody>
                      <tr>
                        ...
                        <td className={'c-data-list__value'}>
                          {metadata.authors[0].first_name}{' '}
                          {metadata.authors[0].last_name}{' '}
                      ...
                      <tr>
                        <th className={'c-data-list__key'}>Published</th>
                        <td className={'c-data-list__value'}>
                          {new Date(
                      ...
                      <tr>
                        ...
                        <td className={'c-data-list__value'}>{metadata.doi}</td>
                      </tr>
                      {metadata.keywords && (
                        <tr>
                          <th className={'c-data-list__key'}>Keywords</th>
                          <td className={'c-data-list__value'}>
                            {metadata.keywords}
                          </td>
                        </tr>
                      ...
                      {metadata.related_publications &&
                        metadata.related_publications.length > 0 && (
                          <tr>
                            <th className={'c-data-list__key'}>
                              Related Publications
                            </th>
                            <td className={'c-data-list__value'}>
                              {metadata.related_publications.map(
                                (publication, index) => (
                                  <>
                                    {index > 0 && <br />}
                                    <a
                                      href={formatPublicationLink(
