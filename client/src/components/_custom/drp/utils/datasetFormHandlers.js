...
export const createSampleModalHandler =
  (dispatch) =>
...
export const createOriginDataModalHandler =
  (dispatch, projectId, portalName) =>
  async (formName, selectedFile = null) => {
    const form = await getFormFields(formName);
...
export const createAnalysisDataModalHandler =
  (dispatch, projectId, portalName) =>
  async (formName, selectedFile = null) => {
    const form = await getFormFields(formName);
