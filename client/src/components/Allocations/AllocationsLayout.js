...
export const Sidebar = props => (
    <Nav id="allocations-sidebar" vertical>
        ...
        <NavItem>
            <NavLink tag={RRNavLink} to='/workbench/allocations/pending' activeClassName='active'>
                <FontAwesomeIcon icon={faClock} size='1x' className="link-icon"/>
                <span className="link-text">Pending</span>
            </NavLink>
        </NavItem>
        <NavItem>
            <NavLink tag={RRNavLink} to='/workbench/allocations/expired' activeClassName='active'>
...
export const Loading = () => <div id="loading"><FontAwesomeIcon icon={faSun} size='8x' spin /></div>;
