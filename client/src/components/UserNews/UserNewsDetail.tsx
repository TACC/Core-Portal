...
const UserNewsDetail = () => {
    ...
    return (
      <>
        ...
        <Section
          ...
          content={
            <SectionTableWrapper
              contentClassName={styles['detail-news-content']}
              contentShouldScroll
            >
  ...
  const timelineEntries = [
    ...
    (entryA, entryB) =>
      new Date(entryB.posted).getTime() - new Date(entryA.posted).getTime()
  );
    ...
    <>
      ...
      <Section
        ...
        content={
          ...
          >
            <article
              className={`${styles['detail-news-list-item']} ${styles['detail-title-row']}`}
            >
              <h2 className={styles['detail-title']}>
                {selectedNews.webtitle.trim()}
              </h2>
            </article>
            ...
            <div>
              {timelineEntries.map((entry) => (
                <article
                  key={entry.id}
                  className={styles['detail-news-list-item']}
                >
                  ...
                  <div
                    className={`${styles['body']} ${styles['body--detail']}`}
                  >
