...
const UIPatternsButton = () => {
  ...
  return (
    <div>
      ...
      <Button className="m-1" iconBeforeName="\e957" type="primary" onClick={() => clickButton('Primary')}>Primary Button</Button>
      ...
      <hr />
      <p>Buttons using the predefined Bootstrap button styles</p>
      <Button className="m-1" size="sm" color="primary" outline onClick={() => clickButton('Primary')}>Primary Button</Button>
      <Button className="m-1" color="secondary" onClick={() => clickButton('Secondary')}>Secondary Button</Button>
