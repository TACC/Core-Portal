const systemDefinitionFixture = {
  ...
  _links: {
    ...
    metadata: {
      href: 'https://portals-api.tacc.utexas.edu/meta/v2/data/?q=%7B%22associationIds%22%3A%221843722814843916777-242ac119-0001-006%22%7D',
    },
    roles: {
      href: 'https://portals-api.tacc.utexas.edu/systems/v2/frontera.home.user/roles',
    },
    self: {
